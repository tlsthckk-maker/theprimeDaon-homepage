...
for (const lang of Object.keys(data)) {
    ...
    original.about = data[lang].about;
    original.contact.company_info.address = data[lang].contact_info.address;
    original.contact.company_info.phone = data[lang].contact_info.phone;
    original.contact.company_info.email = data[lang].contact_info.email;
