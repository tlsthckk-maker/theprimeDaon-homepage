...
export default function ShowroomGallery(props: ShowroomGalleryProps) {
    const rawData = [
        ["Ai_Daon_0.webp", "tech", "테크 에센셜 | 맥세이프 카드홀더", "맥세이프 카드 지갑 (스탠드/밴드형)"],
        ["Ai_Daon_1.webp", "tech", "테크 에센셜 | 디지털/웨어러블 기어", "에어팟 케이스"],
        ["Ai_Daon_2.webp", "life", "라이프스타일 소품 | 키 케이싱 & 키링", "자동차 스마트키 홀더/케이스"],
        ["Ai_Daon_3.webp", "life", "라이프스타일 소품 | 키 케이싱 & 키링", "자동차 스마트키 홀더/케이스"],
        ["Ai_Daon_4.webp", "personal", "퍼스널 레더 굿즈 | 오피스 스테이셔너리", "가죽 다이어리 커버 / 바인더"],
        ["Ai_Daon_5.webp", "tech", "테크 에센셜 | 맥세이프 카드홀더", "맥세이프 카드 지갑 (스탠드/밴드형)"],
        ["Ai_Daon_6.webp", "bag", "가방 & 파우치 | 라이프스타일 파우치", "다목적 소형 미니 파우치"],
        ["Ai_Daon_7.webp", "life", "라이프스타일 소품 | 키 케이싱 & 키링", "가죽 스트랩 & 루프 키링"],
        ["Ai_Daon_8.webp", "tech", "테크 에센셜 | 맥세이프 카드홀더", "맥세이프 카드 지갑 (스탠드/밴드형)"],
        ["Ai_Daon_9.webp", "bag", "가방 & 파우치 | 데일리 & 캐주얼 백", "미니 체인 백 / 사첼백 / 크로스백"],
        ["Ai_Daon_11.webp", "tech", "테크 에센셜 | 맥세이프 카드홀더", "맥세이프 카드 지갑 (스탠드/밴드형)"],
        ["Ai_Daon_12.webp", "tech", "테크 에센셜 | 스마트폰 가죽 케이스", "아이폰 프리미엄 가죽 케이스"],
        ["Ai_Daon_13.webp", "tech", "테크 에센셜 | 맥세이프 카드홀더", "맥세이프 카드 지갑 (스탠드/밴드형)"],
        ["Ai_Daon_14.webp", "tech", "테크 에센셜 | 디지털/웨어러블 기어", "에어팟 / 버즈 가죽 케이스"],
        ["Ai_Daon_15.webp", "personal", "퍼스널 레더 굿즈 | 카드홀더 & 지갑", "컴팩트 지갑 / 슬림 카드홀더"],
        ["Ai_Daon_16.webp", "tech", "테크 에센셜 | 스마트폰 가죽 케이스", "아이폰 프리미엄 가죽 케이스"],
        ["Ai_Daon_17.webp", "tech", "테크 에센셜 | 스마트폰 가죽 케이스", "아이폰 프리미엄 가죽 케이스"],
        ["Ai_Daon_18.webp", "bag", "가방 & 파우치 | 데일리 & 캐주얼 백", "미니 체인 백 / 사첼백 / 크로스백"],
        ["Ai_Daon_19.webp", "tech", "테크 에센셜 | 스마트폰 가죽 케이스", "갤럭시 Z플립/폴드 가죽 케이스"],
        ["Ai_Daon_20.webp", "personal", "퍼스널 레더 굿즈 | 카드홀더 & 지갑", "컴팩트 지갑 / 슬림 카드홀더"],
        ["Ai_Daon_21.webp", "bag", "가방 & 파우치 | 데일리 & 캐주얼 백", "미니 체인 백 / 사첼백 / 크로스백"],
        ["Ai_Daon_22.webp", "bag", "가방 & 파우치 | 데일리 & 캐주얼 백", "미니 체인 백 / 사첼백 / 크로스백"],
        ["Ai_Daon_23.webp", "tech", "테크 에센셜 | 맥세이프 카드홀더", "맥세이프 카드 지갑 (스탠드/밴드형)"],
        ["Ai_Daon_25.webp", "personal", "퍼스널 레더 굿즈 | 트래블 액세서리", "러기지텍"],
        ["Ai_Daon_26.webp", "life", "라이프스타일 소품 | 골프 액세서리", "골프 공 파우치"],
        ["Ai_Daon_27.webp", "tech", "테크 에센셜 | 디지털/웨어러블 기어", "워치 스트랩"],
        ["Ai_Daon_28.webp", "personal", "퍼스널 레더 굿즈 | 카드홀더 & 지갑", "컴팩트 지갑 / 슬림 카드홀더"],
        ["Ai_Daon_29.webp", "bag", "가방 & 파우치 | 비즈니스 백", "가죽 브리프케이스 / 노트북 백"],
        ["Ai_Daon_30.webp", "personal", "퍼스널 레더 굿즈 | 오피스 스테이셔너리", "가죽 다이어리 커버 / 바인더"],
        ["Ai_Daon_31.webp", "personal", "퍼스널 레더 굿즈 | 카드홀더 & 지갑", "컴팩트 지갑 / 슬림 카드홀더"],
        ["Ai_Daon_32.webp", "tech", "테크 에센셜 | 맥세이프 카드홀더", "맥세이프 카드 지갑 (스탠드/밴드형)"],
        ["Ai_Daon_33.webp", "personal", "퍼스널 레더 굿즈 | 카드홀더 & 지갑", "컴팩트 지갑 / 슬림 카드홀더"],
        ["Ai_Daon_35.webp", "bag", "가방 & 파우치 | 라이프스타일 파우치", "다용도 미니 파우치"],
        ["Ai_Daon_36.webp", "life", "라이프스타일 소품 | 키 케이싱 & 키링", "자동차 스마트키 홀더/케이스"],
        ["Ai_Daon_37.webp", "life", "라이프스타일 소품 | 키 케이싱 & 키링", "자동차 스마트키 홀더/케이스"],
        ["Ai_Daon_38.webp", "personal", "퍼스널 레더 굿즈 | 카드홀더 & 지갑", "명함/카드지갑"],
        ["Ai_Daon_39.webp", "tech", "테크 에센셜 | 스마트폰 가죽 케이스", "아이폰 케이스(자수형)"],
        ["Ai_Daon_40.webp", "tech", "테크 에센셜 | 스마트폰 가죽 케이스", "갤럭시 Z플립/폴드 가죽 케이스"],
        ["Ai_Daon_41.webp", "bag", "가방 & 파우치 | 비즈니스 백", "노트북 파우치"],
        ["Ai_Daon_42.webp", "tech", "테크 에센셜 | 산업용/특수 장비 기어", "PDA 및 바코드 단말기 가죽 가드"],
        ["Ai_Daon_43.webp", "bag", "가방 & 파우치 | 데일리 & 캐주얼 백", "미니 체인 백 / 사첼백 / 크로스백"],
        ["Ai_Daon_44.webp", "tech", "테크 에센셜 | 스마트폰 가죽 케이스", "갤럭시 Z플립/폴드 가죽 케이스"],
        ["Ai_Daon_45.webp", "life", "라이프스타일 소품 | 키 케이싱 & 키링", "핸드 스트랩"],
        ["Ai_Daon_46.webp", "tech", "테크 에센셜 | 산업용/특수 장비 기어", "PDA 및 바코드 단말기 가죽 가드"],
        ["Ai_Daon_47.webp", "bag", "가방 & 파우치 | 라이프스타일 파우치", "다용도 미니 파우치"],
        ["Ai_Daon_48.webp", "tech", "테크 에센셜 | 스마트폰 가죽 케이스", "갤럭시 Z플립/폴드 가죽 케이스"],
        ["Ai_Daon_49.webp", "life", "라이프스타일 소품 | 키 케이싱 & 키링", "자동차 스마트키 홀더/케이스"],
        ["Ai_Daon_50.webp", "personal", "퍼스널 레더 굿즈 | 오피스 스테이셔너리", "가죽 다이어리 커버 / 바인더"],
        ["Ai_Daon_51.webp", "tech", "테크 에센셜 | 산업용/특수 장비 기어", "PDA 및 바코드 단말기 가죽 가드"],
        ["Ai_Daon_52.webp", "bag", "가방 & 파우치 | 라이프스타일 파우치", "다용도 미니 파우치"],
        ["Ai_Daon_53.webp", "personal", "퍼스널 레더 굿즈 | 카드홀더 & 지갑", "명함/카드지갑"],
        ["Ai_Daon_54.webp", "bag", "가방 & 파우치 | 라이프스타일 파우치", "다용도 레더 파우치"],
        ["Ai_Daon_55.webp", "life", "라이프스타일 소품 | 키 케이싱 & 키링", "벨트 클립"],
        ["Ai_Daon_56.webp", "personal", "퍼스널 레더 굿즈 | 트래블 액세서리", "러기지텍"],
        ["Ai_Daon_57.webp", "tech", "테크 에센셜 | 디지털/웨어러블 기어", "에어팟 케이스"],
        ["Ai_Daon_59.webp", "bag", "가방 & 파우치 | 라이프스타일 파우치", "다용도 미니 파우치"],
        ["Ai_Daon_60.webp", "tech", "테크 에센셜 | 디지털/웨어러블 기어", "에어팟 / 버즈 가죽 케이스"],
        ["Ai_Daon_61.webp", "bag", "가방 & 파우치 | 데일리 & 캐주얼 백", "미니 체인 백 / 사첼백 / 크로스백"],
        ["Ai_Daon_62.webp", "bag", "가방 & 파우치 | 라이프스타일 파우치", "가죽 선글라스/안경 케이스"],
        ["Ai_Daon_63.webp", "life", "라이프스타일 소품 | 키 케이싱 & 키링", "자동차 스마트키 홀더/케이스"],
        ["Ai_Daon_64.webp", "life", "라이프스타일 소품 | 키 케이싱 & 키링", "핸드스트랩"],
        ["Ai_Daon_65.webp", "life", "라이프스타일 소품 | 골프 액세서리", "골프-아이언커버"],
        ["Ai_Daon_66.webp", "life", "라이프스타일 소품 | 골프 액세서리", "골프-아이언커버"],
        ["Ai_Daon_67.webp", "bag", "가방 & 파우치 | 라이프스타일 파우치", "다용도 레더 파우치"],
        ["Ai_Daon_68.webp", "tech", "테크 에센셜 | 스마트폰 가죽 케이스", "아이폰 프리미엄 케이스"],
        ["Ai_Daon_69.webp", "tech", "테크 에센셜 | 스마트폰 가죽 케이스", "아이폰 프리미엄 케이스"]
    ];
