                ...
                <div className="portfolio-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-[60px]">
                    ...
                    <div className="portfolio-item stagger-item cursor-pointer group" onClick={() => window.location.href = `/${lng}/showroom`}>
                        <div className="img-placeholder w-full aspect-[4/5] bg-[#e5e5ea] rounded-[18px] overflow-hidden">
                            <img src="/images/Ai_Daon_12.png" alt="프리미엄 소가죽 스마트폰 케이스 OEM 제작 샘플" className="portfolio-image-inner w-full h-full object-cover" />
                        </div>
                    ...
                    <div className="portfolio-item stagger-item cursor-pointer group" onClick={() => window.location.href = `/${lng}/showroom`}>
                        <div className="img-placeholder w-full aspect-[4/5] bg-[#e5e5ea] rounded-[18px] overflow-hidden">
                            <img src="/images/Ai_Daon_6.png" alt="베지터블 소가죽 다목적 소형 파우치 ODM 제작 샘플" className="portfolio-image-inner w-full h-full object-cover" />
                        </div>
                    ...
                    <div className="portfolio-item stagger-item cursor-pointer group" onClick={() => window.location.href = `/${lng}/showroom`}>
                        <div className="img-placeholder w-full aspect-[4/5] bg-[#e5e5ea] rounded-[18px] overflow-hidden">
                            <img src="/images/Ai_Daon_5.png" alt="블랙 브라이들 가죽 슬림 카드홀더 OEM 제작 샘플" className="portfolio-image-inner w-full h-full object-cover" />
                        </div>
                    ...
                    <div className="portfolio-item stagger-item cursor-pointer group" onClick={() => window.location.href = `/${lng}/showroom`}>
                        <div className="img-placeholder w-full aspect-[4/5] bg-[#e5e5ea] rounded-[18px] overflow-hidden">
                            <img src="/images/Ai_Daon_2.png" alt="브라운 소가죽 자동차 스마트키 홀더 맞춤 제작 샘플" className="portfolio-image-inner w-full h-full object-cover" />
                        </div>
